    ...
    return (
        <>
            <div className="h-44 mt-48 md:mt-8 bg-[#45AAF2] rounded-md flex flex justify-between items-center px-4">
                <div>
                    <h1 className="text-2xl md:text-4xl">Police Station - Kandy</h1>
            ...
            <div className="mt-8 flex flex-col lg:flex-row gap-2">
                ...
                <div className="w-full lg:w-[21%] lg:ml-14 h-[140px] bg-[#F5CD79] rounded-md flex flex-col items-center justify-center">
